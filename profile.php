<div class="menu">
        	<div class="welcome">
        	<p class="prosto">Пивет</p><p class="neprosto">Пряник</p><p class="prosto">твой баланс составляет</p><p class="neprosto">16 155 р.</p>
			</div>
            <div class="balance">
            <div class="input">
            ...
            <div class="output">
                ...
                <input type="submit" name="input" value="вывести">
                <input type="text" name="ik_am" value="100.00" />
                </form>
            </div>
            ...
            <div class="depositButton">
                <form method="post" action="/" enctype="utf-8">
                <input type="submit" name="input" value="создать">
                <input type="text" name="ik_am" value="1000.00" />
                </form>
            </div>
            <div class="statusDep">
